...
path_models= os.path.join(os.path.dirname(__file__),'diabetes_models')
path_validation_curves = os.path.join(os.path.dirname(__file__),'diabetes_validation_curves')
path_figures = os.path.join(os.path.dirname(__file__),'diabetes_figures')
path_dataframes = os.path.join(os.path.dirname(__file__),'diabetes_dataframes')
...
# <------------------------- MACHINE LEARNING MODELS -------------------------> #
    ...
    # dbc.Row([dbc.Col([dcc.Graph(figure=learning_curve)],width=12)]),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        # Cierre del layout
    ],fluid = True,style={'padding':'0rem 6.5rem 2rem 6.5rem','color':'#373a3c'})
