...
path_models= os.path.join(os.path.dirname(__file__),'titanic_models')
path_validation_curves = os.path.join(os.path.dirname(__file__),'titanic_validation_curves')
path_figures = os.path.join(os.path.dirname(__file__),'titanic_figures')
path_dataframes = os.path.join(os.path.dirname(__file__),'titanic_dataframes')

# Dash(__name__,external_stylesheets=[dbc.themes.SUPERHERO],title='Titanic',\
...
anova_correlation.update_layout(xaxis_title="")
...
if os.path.exists(os.path.join(os.path.dirname(__file__),'titanic_models')):
    path_models = os.path.join(os.path.dirname(__file__),'titanic_models')
else:
    os.mkdir(os.path.join(os.path.dirname(__file__),'titanic_models'))
    path_models= os.path.join(os.path.dirname(__file__),'titanic_models')

if os.path.exists(os.path.join(os.path.dirname(__file__),'titanic_validation_curves')):
    path_validation_curves = os.path.join(os.path.dirname(__file__),'titanic_validation_curves')
else:
    os.mkdir(os.path.join(os.path.dirname(__file__),'titanic_validation_curves'))
    path_validation_curves = os.path.join(os.path.dirname(__file__),'titanic_validation_curves')
...
layout = dbc.Container([ 
    ...
    dbc.Row(dbc.Col(html.H1('Titanic DataFrame'),width=6)),
    ...
    dbc.Row(dbc.Col(html.Br(),width=12)), # Blank Line
    ...
    dbc.Row(dbc.Col([html.H3('Numerical Correlation')],width=12,
                             className="subtitle",style={"textAlign": "left"})),
    ...
    dbc.Row(dbc.Col([html.H3('Categorical Correlation')],width=12,
                             className="subtitle",style={"textAlign": "left"})),
    ...
    dbc.Row([dbc.Col([dcc.Graph(figure=chi2_correlation)],width=6),\
     ...
     dbc.Row(dbc.Col([html.P("Pearson's chi-squared statistical hypothesis test is \
        ...
        For the feature selection and data preprocessing many \
    ...
    dbc.Row(dbc.Col(id='prediction_titanic',children=[],width=12)),
  ...
  # Layoud close
  ],fluid = True,style={'background-color':"#0f2537", 'padding':'0rem 6.5rem 0rem 6.5rem', 'color':'#edeef0'})

@dash.callback(
    Output('prediction_titanic','children'),
