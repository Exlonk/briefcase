...
import diskcache
cache = diskcache.Cache("./phosphate_cache")
background_callback_manager = DiskcacheManager(cache)          

# Functions

path_models= os.path.join(os.path.dirname(__file__),'phosphate_models')
path_validation_curves = os.path.join(os.path.dirname(__file__),'phosphate_validation_curves')
path_figures = os.path.join(os.path.dirname(__file__),'phosphate_figures')
path_dataframes = os.path.join(os.path.dirname(__file__),'phosphate_dataframes')
...
df = pd.read_csv(os.path.join(os.path.dirname(__file__),'phosphate.csv'))
...
df_feature = pd.read_csv(os.path.join((os.path.join(os.path.dirname(__file__),'phosphate_feature_selection')),'feature_selection.csv'))
...
layout = dbc.Container([ 
    ...
    dbc.Row(dbc.Col(html.Br(),width=12)), # V Space
    ...
    dbc.Row(dbc.Col([html.H3("Learning Curve")])),
    ...
    dbc.Row([dbc.Col([],width=3),dbc.Col(id='prediction_phosphate',children=[],width=6),
            dbc.Col([],width=3)])
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                # Cierre del layout
    ],fluid = True,style={'background-color':"#1B2B35", 'padding':'0rem 6.5rem 0rem 6.5rem', 'color':'#edeef0'})


@dash.callback(
    Output('prediction_phosphate','children'),
